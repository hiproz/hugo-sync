# What is hugo-synchronization
hugo-synchronization is an **automaticlly solution** that update your site page from github or your wordpress site based on [HUGO](https://gohugo.io).
...
3. Automation:do notice,all is done！
